...
export type GameSpritesheet3 = Spritesheet<typeof data>;

/** A record with all the animated textures of the game. */
export type Animations3 = GameSpritesheet3["animations"];

/** A record with all the static textures of the game. */
export type Textures3 = GameSpritesheet3["textures"];

// A global reference to the game spritesheet with all our textures.
let spritesheet: GameSpritesheet3;
 ...
 */
export async function getSpritesheet3() {
  if (spritesheet) {
    return spritesheet;
  }

  const spritesheetTexture = await Assets.load("spritesheet3");
